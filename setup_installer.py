...
'''
    ...
    def show_final_instructions(self):
        ...
        print("   python rtpa.py              # Interface principale")
        print("   python rtpa_studio.py       # Lanceur alternatif")
        print("   python main_headless.py     # Mode console")
        print()
        print("📚 DOCUMENTATION:")
        print("   README.md                   # Guide complet")
        print("   CALIBRAGE_OCR_README.md     # Guide calibrage OCR")
        print()
        print("⚙️ CONFIGURATION:")
        print("   1. Ouvrez votre client poker (PokerStars, Winamax, etc.)")
        print("   2. Lancez RTPA Studio")
        print("   3. Allez dans l'onglet '🔧 Paramètres'")
        print("   4. Section '🔍 Calibrage OCR'")
        print("   5. Cliquez '🤖 Auto-Calibrage'")
        print("   6. Testez avec '🔍 Tester OCR'")
        print()
        print("📧 SUPPORT:")
        print("   • Lisez d'abord la documentation")
        print("   • Vérifiez les logs dans logs/")
        print("   • Pour l'aide technique: voir README.md")
        print()
        print("⚠️  USAGE RESPONSABLE:")
        print("   Ce logiciel est exclusivement destiné à l'étude et")
        print("   à la recherche académique. Usage éducatif uniquement.")
    ...
    def run_installation(self):
        ...
        if success:
            print("\n🎯 Installation réussie! Lancez: python rtpa.py")
        else:
            print("\n⚠️ Installation partielle. Consultez la documentation.")
